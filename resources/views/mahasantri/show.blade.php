                                ...
                                <div class="col-lg-12">
                                    <div class="full dis_flex center_text">
                                        <div class="profile_img"><img width="180" class="rounded-circle"
                                                src="{{ asset('upload') }}/{{ $mahasantri->gambar }}" alt="#"></div>
                                        <div class="profile_contant">
                                            <div class="contact_inner">
                                                <h3>{{ $mahasantri->nama_mhs }}</h3>
                                                <p><strong>Status:
                                                    </strong>
                                                    @if ($mahasantri->status == 'l')
                                                        <span class="badge bg-primary text-white">lanjut</span>
                                                    @else
                                                        <span class="badge bg-danger text-white">ulang</span>
                                                    @endif
                                                </p>
