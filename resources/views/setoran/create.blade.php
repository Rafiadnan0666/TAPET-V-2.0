...
@endsection
@section('header')
    <h2 style="width: max-content">Tambah Data Setoran</h2>
@endsection
@section('konten')
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('setoran.store') }}" enctype="multipart/form-data"
                                        method="post">
                                        @csrf
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="number" value="{{ old('juz') }}" name="juz"
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="number" value="{{ old('halaman') }}" name="halaman"
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="number" value="{{ old('nilai') }}" name="nilai"
