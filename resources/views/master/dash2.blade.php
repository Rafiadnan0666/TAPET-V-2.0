            ...
            <nav id="sidebar">
                ...
                <div class="sidebar_blog_2">
                    ...
                    <ul class="list-unstyled components">
                        ...
                        <li><a href="{{ asset('dist') }}/widgets.html"><i class="fa fa-clock-o orange_color"></i>
                                <span>Widgets</span></a>
                        </li>
                        <li>
                            ...
                            <ul class="collapse list-unstyled" id="element">
                                <li><a href="{{ asset('dist') }}/general_elements.html">> <span>General
                                            Elements</span></a></li>
                                <li><a href="{{ asset('dist') }}/media_gallery.html">> <span>Media Gallery</span></a>
                                </li>
                                <li><a href="{{ asset('dist') }}/icons.html">> <span>Icons</span></a></li>
                                <li><a href="{{ asset('dist') }}/invoice.html">> <span>Invoice</span></a></li>
                            </ul>
                        </li>
                        <li><a href="{{ asset('dist') }}/tables.html"><i class="fa fa-table purple_color2"></i>
                        ...
                        <li><a href="{{ asset('dist') }}/price.html"><i class="fa fa-briefcase blue1_color"></i>
                                <span>Pricing
                                    Tables</span></a></li>
                        <li>
                        ...
                        <li><a href="{{ asset('dist') }}/map.html"><i class="fa fa-map purple_color2"></i>
                                <span>Map</span></a></li>
                        <li><a href="{{ asset('dist') }}/charts.html"><i class="fa fa-bar-chart-o green_color"></i>
                                <span>Charts</span></a></li>
                        <li><a href="{{ asset('dist') }}/settings.html"><i class="fa fa-cog yellow_color"></i>
                ...
                <div class="topbar">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <div class="full">
                            ...
                            <div class="logo_section">
                                <a href="{{ asset('dist') }}/index.html"><img class="img-responsive"
                                ...
                                <div class="dash_blog">
                                    <div class="dash_blog_inner">
                                        ...
                                        <div class="msg_list_main">
                                            <ul class="msg_list">
                                                <li>
                                                    <span><img src="{{ asset('dist') }}/images/layout_img/msg2.png"
                                                ...
                                                <li>
                                                    <span><img src="{{ asset('dist') }}/images/layout_img/msg3.png"
                                                            class="img-responsive" alt="#" /></span>
                                                    <span>
                                                        <span class="name_user">John Smith</span>
